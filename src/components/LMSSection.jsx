...
export default function AppSection({ t }) {
    ...
    return (
        <section id="app" className="bg-[#1A1510] py-24 lg:py-12 px-4 sm:px-6">
            <div className="mx-auto max-w-7xl grid  gap-2 items-center">
                ...
                <div className="flex gap-3 mb-8 overflow-x-auto pb-2 mx-auto">
                    {features.map((feat, i) => (
                        <button
                            key={feat.title}
                            onClick={() => setActive(i)}
                ...
                <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="flex justify-center">
                        <div className="w-full max-w-3xl">
                            <div className="aspect-4/3 w-full rounded-3xl overflow-hidden border border-[#C8974A]/12 bg-gradient-to-br from-[#0D0B08] to-[#1A1510] flex items-center justify-center">
                                <div className="h-full w-full flex items-center justify-center">
                                    <div className="h-[92%] w-[92%] rounded-2xl bg-[linear-gradient(180deg,#111 0%,#2a2219 100%)] flex items-center justify-center overflow-hidden p-4">
