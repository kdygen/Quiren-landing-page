export const translations = {
    RU: {
        ...
        heroDescription:
            "Первая умная домбра с LED-подсветкой и живой обратной связью. Quimen объединяет традиционную домбру и современные технологии. Устройство показывает, куда ставить пальцы, слушает вашу игру через телефон и помогает шаг за шагом освоить кюи – от первых нот до сложных произведений.",
